...
#define MS_CLASS "X2Utils::String"
...
namespace X2Utils
{
	std::string X2Utils::String::Base64Encode(const uint8_t* data, size_t len)
	{
		MS_TRACE();
	...
	std::string X2Utils::String::Base64Encode(const std::string& str)
	{
		MS_TRACE();
	...
	uint8_t* X2Utils::String::Base64Decode(const uint8_t* data, size_t len, size_t& outLen)
	{
		MS_TRACE();
	...
	uint8_t* X2Utils::String::Base64Decode(const std::string& str, size_t& outLen)
	{
		MS_TRACE();
	...
	std::vector<std::string> X2Utils::String::Split(const std::string& str, char separator, size_t limit)
	{
