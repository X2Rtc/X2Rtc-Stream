...
*/
#ifndef MS_X2RTC_TCP_SERVER_HPP
#define MS_X2RTC_TCP_SERVER_HPP
...
namespace x2rtc {
	...
	class X2TcpServer : public ::X2TcpServerHandler
	{
	public:
		class Listener
		{
	...
	public:
		X2TcpServer(Listener* listener);
		~X2TcpServer() override;
