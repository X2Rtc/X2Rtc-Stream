...
namespace Channel
{
	...
	//@Eric 
	class ChannelPSocket : public ConsumerSocket::Listener
	{
	public:
		class Listener
		{
		...
		public:
			virtual void OnChannelPResponse(
				Channel::ChannelPSocket* channel, json* respone) = 0;
			virtual void OnChannelPClosed(Channel::ChannelPSocket* channel) = 0;
		};

	public:
		explicit ChannelPSocket(int consumerFd, int producerFd);
		virtual ~ChannelPSocket();
