#define MSC_CLASS "Sdp::MRtcSdp"

#include "sdp/MRtcSdp.hpp"
#include "Logger.hpp"
...
namespace mediasoupclient
{
	...
	void Sdp::MRtcSdp::UpdateIceParameters(const json& iceParameters)
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::UpdateDtlsRole(const std::string& role)
	{
		MS_TRACE();
	...
	Sdp::MRtcSdp::MediaSectionIdx Sdp::MRtcSdp::GetNextMediaSectionIdx()
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::SendSctpAssociation(json& offerMediaObject)
	{
	...
	void Sdp::MRtcSdp::RecvSctpAssociation()
	{
		nlohmann::json emptyJson;
	...
	void Sdp::MRtcSdp::DisableMediaSection(const std::string& mid)
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::CloseMediaSection(const std::string& mid)
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::AddMediaSection(MediaSection* newMediaSection)
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::ReplaceMediaSection(MediaSection* newMediaSection, const std::string& reuseMid)
	{
		MS_TRACE();
	...
	void Sdp::MRtcSdp::RegenerateBundleMids()
	{
		MS_TRACE();
