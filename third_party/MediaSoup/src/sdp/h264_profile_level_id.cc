...
struct LevelConstraint {
  ...
  const mrtc::H264::Level level;
};

// This is from ITU-T H.264 (02/2016) Table A-1 – Level limits.
static constexpr LevelConstraint kLevelConstraints[] = {
    {1485, 99, mrtc::H264::kLevel1},
    {1485, 99, mrtc::H264::kLevel1_b},
    {3000, 396, mrtc::H264::kLevel1_1},
    {6000, 396, mrtc::H264::kLevel1_2},
    {11880, 396, mrtc::H264::kLevel1_3},
    {11880, 396, mrtc::H264::kLevel2},
    {19800, 792, mrtc::H264::kLevel2_1},
    {20250, 1620, mrtc::H264::kLevel2_2},
    {40500, 1620, mrtc::H264::kLevel3},
    {108000, 3600, mrtc::H264::kLevel3_1},
    {216000, 5120, mrtc::H264::kLevel3_2},
    {245760, 8192, mrtc::H264::kLevel4},
    {245760, 8192, mrtc::H264::kLevel4_1},
    {522240, 8704, mrtc::H264::kLevel4_2},
    {589824, 22080, mrtc::H264::kLevel5},
    {983040, 36864, mrtc::H264::kLevel5_1},
    {2073600, 36864, mrtc::H264::kLevel5_2},
};
...
bool IsSameH264Profile(const CodecParameterMap& params1,
  ...
  const absl::optional<mrtc::H264::ProfileLevelId> profile_level_id =
      mrtc::H264::ParseSdpProfileLevelId(params1);
  const absl::optional<mrtc::H264::ProfileLevelId> other_profile_level_id =
      mrtc::H264::ParseSdpProfileLevelId(params2);
