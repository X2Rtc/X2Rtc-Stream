...
void aom_av1_test(void)
{
	...
	struct aom_av1_t av1;
	RTC_F_CHECK(sizeof(src) == aom_av1_codec_configuration_record_load(src, sizeof(src), &av1));
	RTC_F_CHECK(1 == av1.version && 0 == av1.seq_profile && 4 == av1.seq_level_idx_0);
	RTC_F_CHECK(0 == av1.seq_tier_0 && 0 == av1.high_bitdepth && 0 == av1.twelve_bit && 0 == av1.monochrome && 1 == av1.chroma_subsampling_x && 1 == av1.chroma_subsampling_y && 0 == av1.chroma_sample_position);
	RTC_F_CHECK(0 == av1.initial_presentation_delay_present && 0 == av1.initial_presentation_delay_minus_one);
	RTC_F_CHECK(13 == av1.bytes);
	RTC_F_CHECK(sizeof(src) == aom_av1_codec_configuration_record_save(&av1, data, sizeof(data)));
	RTC_F_CHECK(0 == memcmp(src, data, sizeof(src)));

	aom_av1_codecs(&av1, (char*)data, sizeof(data));
	RTC_F_CHECK(0 == memcmp("av01.0.04M.08", data, 13));
}
...
void aom_av1_sequence_header_obu_test(void)
{
	...
	RTC_F_CHECK(0 == aom_av1_obu_sequence_header(&av1, obu, sizeof(obu)));
}
