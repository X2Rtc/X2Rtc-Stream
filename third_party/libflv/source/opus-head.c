...
void opus_head_test(void)
{
    ...
    RTC_F_CHECK(sizeof(src) == opus_head_load(src, sizeof(src), &opus));
    RTC_F_CHECK(1 == opus.version && 2 == opus.channels && 120 == opus.pre_skip && 48000 == opus.input_sample_rate && 0 == opus.output_gain);
    RTC_F_CHECK(0 == opus.channel_mapping_family && 1 == opus.stream_count && 1 == opus.coupled_count);
    RTC_F_CHECK(0 == memcmp(opus_channel_map[opus.channels-1], opus.channel_mapping, 8));
    RTC_F_CHECK(sizeof(src) == opus_head_save(&opus, data, sizeof(data)));
