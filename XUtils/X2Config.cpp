...
int X2ConfigSet::LoadFromFile( const char * filename, int * errline )
{
...
char * X2ConfigSet::skip_blank( char * str )
{
...
char * X2ConfigSet::skip_to_blank( char * str )
{
	//ASSERT_RET( ( str != NULL ), NULL );
	char * p = str;
	while( *p != ' ' && *p != '\t' && *p != '\r' && *p != '\n' && *p != '\0' )
...
int X2ConfigSet::StoreToFile( const char * filename )
{
	//ASSERT_RET( ( filename != NULL ), -1 );
...
int X2ConfigSet::Dump( void )
{
	return StoreToFile( m_fname.c_str() );
}

// get value, return NULL when not found.
const char * X2ConfigSet::GetValue( const char * sectname, const char * key, const char * default_val ) const
{
...
int X2ConfigSet::SetValue( const char * sectname, const char * key, const char * value )
{
...
int X2ConfigSet::GetIntVal( const char * sectname, const char * key, int default_val ) const
{
...
int X2ConfigSet::SetIntVal( const char * sectname, const char * key, int value )
{
	//ASSERT_RET( ( sectname != NULL && key != NULL ), -1 );
...
double X2ConfigSet::GetDblVal( const char * sectname, const char * key, double default_val ) const
{
...
int X2ConfigSet::SetDblVal( const char * sectname, const char * key, double value )
{
	//ASSERT_RET( ( sectname != NULL && key != NULL ), -1 );
...
double X2ConfigSet::GetInt64Val( const char * sectname, const char * key, double default_val ) const
{
	//ASSERT_RET( ( sectname != NULL && key != NULL ), -1 );
...
int X2ConfigSet::SetInt64Val( const char * sectname, const char * key, double value )
{
	//ASSERT_RET( ( sectname != NULL && key != NULL ), -1 );
...
int X2ConfigSet::DelKey( const char * sectname, const char * key )
{
	//ASSERT_RET( ( sectname != NULL && key != NULL ), -1 );
...
int X2ConfigSet::DelSection( const char * sectname )
{
...
int X2ConfigSet::GetSectionNum() const
{
	return (int)m_cfg.size();
}

const char * X2ConfigSet::GetSectionName( int index ) const
{
...
int X2ConfigSet::GetSectionKeyNum( const char * sectname ) const
{
	//ASSERT_RET( (sectname != NULL), -1 );
...
const char * X2ConfigSet::GetSectionKeyName( const char * sectname, int index ) const
{
